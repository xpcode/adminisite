								...
								<div class="cleditorMain" style="width: 500px; height: 250px;">
									<div class="cleditorToolbar" style="height: 53px;">
										...
										<div class="cleditorGroup">
											...
											<div class="cleditorButton" title="Insert Hyperlink" style="background-position: -576px center;"></div>
											<div class="cleditorButton" title="Remove Hyperlink" style="background-position: -600px center;"></div>
											<div class="cleditorDivider"></div>
										</div>
										<div class="cleditorGroup">
											<div class="cleditorButton cleditorDisabled" title="Cut" style="background-position: -624px center;" disabled="disabled"></div>
											<div class="cleditorButton cleditorDisabled" title="Copy" style="background-position: -648px center;" disabled="disabled"></div>
