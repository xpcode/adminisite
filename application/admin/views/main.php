			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i>
						<span class="hidden-phone"><?=$userinfo["username"] ?></span>
						<span class="caret"></span>
					</a>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="ajax-link" href="notice">
								<i class="icon-home"></i>
								<span class="hidden-tablet">公告管理</span>
							</a>
						</li>
						<li>
						...
						<li>
							<a class="ajax-link" href="file-manager.html">
						...
						<li>
							<a href="tour.html">
								...
								<span class="hidden-tablet">Tour</span>
							</a>
						</li>
						<li>
						...
						<li>
							<a href="error.html">
								...
								<span class="hidden-tablet">Error Page</span>
							</a>
						</li>
						<li>
							<a href="login.html">
				...
				<div class="row-fluid">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<p class="center">
								<a href="http://usman.it/free-responsive-admin-template" class="btn btn-large btn-primary">
									<i class="icon-chevron-left icon-white"></i>
									Back to article
								</a>
								<a href="http://usman.it/free-responsive-admin-template" class="btn btn-large">
						...
						<div class="box-content">
							<div class="box-content">
								<ul class="dashboard-list">
									<li>
										<a href="#">
											<img class="dashboard-avatar" alt="Usman" src="http://www.gravatar.com/avatar/f0ea51fa1e4fae92608d8affee12f67b.png?s=50"></a> <strong>Name:</strong>
										<a href="#">Usman</a>
