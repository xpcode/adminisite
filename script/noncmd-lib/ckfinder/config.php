...
function CheckAuthentication()
{
	...
	return true;//isset($_SESSION['userinfo']);
}
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . '/' . date("Y") . '/' . date("m") . 'files',
		'directory' => $baseDir . '/' . date("Y") . '/' . date("m") . 'files',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . '/' . date("Y") . '/' . date("m") . 'images',
		'directory' => $baseDir . '/' . date("Y") . '/' . date("m") . 'images',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . '/' . date("Y") . '/' . date("m") . 'flash',
		'directory' => $baseDir . '/' . date("Y") . '/' . date("m") . 'flash',
		'maxSize' => 0,
